...
{
  /* My_Services */
  CUSTOM_STM_MY_TX_CHAR,
  CUSTOM_STM_MY_RX_CHAR,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* MY_TX_CHAR */
  CUSTOM_STM_MY_TX_CHAR_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_MY_TX_CHAR_NOTIFY_DISABLED_EVT,
  /* MY_RX_CHAR */
  CUSTOM_STM_MY_RX_CHAR_WRITE_NO_RESP_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeMy_Tx_Char;
extern uint16_t SizeMy_Rx_Char;
